...
type LayoutRouteId = RouteId | "/" | "/justChat" | "/justChat/[id]" | "/story" | "/story/[id]" | "/test" | "/test/[id]" | null
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../node_modules/@sveltejs/kit/src/routes/+page.server.js').load>>>>>>;
